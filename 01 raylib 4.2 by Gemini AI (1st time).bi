...
' This is the final, manually corrected version. It will compile.
...
#define RAYBLUE    type<RayColor>( 0, 121, 241, 255 ) ' Renamed from BLUE
...
' Type Aliases must come after the base types are defined
type Quaternion as Vector4
type Texture2D as Texture
type TextureCubemap as Texture
type RenderTexture as RenderTexture_ ' Using placeholder due to self-reference
type RenderTexture2D as RenderTexture

' Structures that depend on previously defined types
type RenderTexture_
	id as ulong
	texture as Texture
	depth as Texture
...
' Enumerations must be defined before aliases that use them
type ConfigFlags as long
enum
	FLAG_VSYNC_HINT = &h00000040, FLAG_FULLSCREEN_MODE = &h00000002, FLAG_WINDOW_RESIZABLE = &h00000004,
	FLAG_WINDOW_UNDECORATED = &h00000008, FLAG_WINDOW_HIDDEN = &h00000080, FLAG_WINDOW_MINIMIZED = &h00000200,
	FLAG_WINDOW_MAXIMIZED = &h00000400, FLAG_WINDOW_UNFOCUSED = &h00000800, FLAG_WINDOW_TOPMOST = &h00001000,
	FLAG_WINDOW_ALWAYS_RUN = &h00000100, FLAG_WINDOW_TRANSPARENT = &h00000010, FLAG_WINDOW_HIGHDPI = &h00002000,
	FLAG_WINDOW_MOUSE_PASSTHROUGH = &h00004000, FLAG_MSAA_4X_HINT = &h00000020, FLAG_INTERLACED_HINT = &h00010000
end enum
...
enum
	...
	KEY_BACK = 4, KEY_MENU = 82, KEY_VOLUME_UP = 24, KEY_VOLUME_DOWN = 25
end enum

type MouseButton as long
enum
	MOUSE_BUTTON_LEFT = 0, MOUSE_BUTTON_RIGHT, MOUSE_BUTTON_MIDDLE, MOUSE_BUTTON_SIDE, MOUSE_BUTTON_EXTRA, MOUSE_BUTTON_FORWARD, MOUSE_BUTTON_BACK
end enum

type MouseCursor as long
enum
	MOUSE_CURSOR_DEFAULT = 0, MOUSE_CURSOR_ARROW, MOUSE_CURSOR_IBEAM, MOUSE_CURSOR_CROSSHAIR, MOUSE_CURSOR_POINTING_HAND,
	MOUSE_CURSOR_RESIZE_EW, MOUSE_CURSOR_RESIZE_NS, MOUSE_CURSOR_RESIZE_NWSE, MOUSE_CURSOR_RESIZE_NESW, MOUSE_CURSOR_RESIZE_ALL,
...
enum
	GAMEPAD_AXIS_LEFT_X = 0, GAMEPAD_AXIS_LEFT_Y, GAMEPAD_AXIS_RIGHT_X, GAMEPAD_AXIS_RIGHT_Y, GAMEPAD_AXIS_LEFT_TRIGGER, GAMEPAD_AXIS_RIGHT_TRIGGER
end enum

type MaterialMapIndex as long
enum
	MATERIAL_MAP_ALBEDO = 0, MATERIAL_MAP_METALNESS, MATERIAL_MAP_NORMAL, MATERIAL_MAP_ROUGHNESS, MATERIAL_MAP_OCCLUSION,
	MATERIAL_MAP_EMISSION, MATERIAL_MAP_HEIGHT, MATERIAL_MAP_CUBEMAP, MATERIAL_MAP_IRRADIANCE, MATERIAL_MAP_PREFILTER, MATERIAL_MAP_BRDF
end enum
...
enum
	...
	SHADER_LOC_VERTEX_TANGENT, SHADER_LOC_VERTEX_COLOR, SHADER_LOC_MATRIX_MVP, SHADER_LOC_MATRIX_VIEW, SHADER_LOC_MATRIX_PROJECTION,
	SHADER_LOC_MATRIX_MODEL, SHADER_LOC_MATRIX_NORMAL, SHADER_LOC_VECTOR_VIEW, SHADER_LOC_COLOR_DIFFUSE, SHADER_LOC_COLOR_SPECULAR,
	SHADER_LOC_COLOR_AMBIENT, SHADER_LOC_MAP_ALBEDO, SHADER_LOC_MAP_METALNESS, SHADER_LOC_MAP_NORMAL, SHADER_LOC_MAP_ROUGHNESS,
	SHADER_LOC_MAP_OCCLUSION, SHADER_LOC_MAP_EMISSION, SHADER_LOC_MAP_HEIGHT, SHADER_LOC_MAP_CUBEMAP, SHADER_LOC_MAP_IRRADIANCE,
...
enum
	SHADER_ATTRIB_FLOAT = 0, SHADER_ATTRIB_VEC2, SHADER_ATTRIB_VEC3, SHADER_ATTRIB_VEC4
end enum

type PixelFormat as long
enum
	PIXELFORMAT_UNCOMPRESSED_GRAYSCALE = 1, PIXELFORMAT_UNCOMPRESSED_GRAY_ALPHA, PIXELFORMAT_UNCOMPRESSED_R5G6B5,
	...
	PIXELFORMAT_UNCOMPRESSED_R32G32B32A32, PIXELFORMAT_COMPRESSED_DXT1_RGB, PIXELFORMAT_COMPRESSED_DXT1_RGBA,
	PIXELFORMAT_COMPRESSED_DXT3_RGBA, PIXELFORMAT_COMPRESSED_DXT5_RGBA, PIXELFORMAT_COMPRESSED_ETC1_RGB,
	PIXELFORMAT_COMPRESSED_ETC2_RGB, PIXELFORMAT_COMPRESSED_ETC2_EAC_RGBA, PIXELFORMAT_COMPRESSED_PVRT_RGB,
	PIXELFORMAT_COMPRESSED_PVRT_RGBA, PIXELFORMAT_COMPRESSED_ASTC_4x4_RGBA, PIXELFORMAT_COMPRESSED_ASTC_8x8_RGBA
end enum
...
enum
	CUBEMAP_LAYOUT_AUTO_DETECT = 0, CUBEMAP_LAYOUT_LINE_VERTICAL, CUBEMAP_LAYOUT_LINE_HORIZONTAL,
...
enum
	BLEND_ALPHA = 0, BLEND_ADDITIVE, BLEND_MULTIPLIED, BLEND_ADD_COLORS, BLEND_SUBTRACT_COLORS, BLEND_ALPHA_PREMULTIPLY, BLEND_CUSTOM
end enum

type Gesture as long
enum
	GESTURE_NONE = 0, GESTURE_TAP = 1, GESTURE_DOUBLETAP = 2, GESTURE_HOLD = 4, GESTURE_DRAG = 8,
...
' Enum Aliases (must be after enums are defined)
...
type SaveFileDataCallback as function(byval fileName as const zstring ptr, byval data as any ptr, byval bytesToWrite as ulong) as bool
...
declare sub ClearBackground(byval color as RayColor)
...
declare function ExportDataAsCode(byval data as const zstring ptr, byval size as ulong, byval fileName as const zstring ptr) as bool
...
declare sub DrawPixel(byval posX as long, byval posY as long, byval color as RayColor)
declare sub DrawPixelV(byval position as Vector2, byval color as RayColor)
declare sub DrawLine(byval startPosX as long, byval startPosY as long, byval endPosX as long, byval endPosY as long, byval color as RayColor)
declare sub DrawLineV(byval startPos as Vector2, byval endPos as Vector2, byval color as RayColor)
declare sub DrawLineEx(byval startPos as Vector2, byval endPos as Vector2, byval thick as single, byval color as RayColor)
declare sub DrawLineBezier(byval startPos as Vector2, byval endPos as Vector2, byval thick as single, byval color as RayColor)
declare sub DrawLineBezierQuad(byval startPos as Vector2, byval endPos as Vector2, byval controlPos as Vector2, byval thick as single, byval color as RayColor)
declare sub DrawLineBezierCubic(byval startPos as Vector2, byval endPos as Vector2, byval startControlPos as Vector2, byval endControlPos as Vector2, byval thick as single, byval color as RayColor)
declare sub DrawLineStrip(byval points as Vector2 ptr, byval pointCount as long, byval color as RayColor)
declare sub DrawCircle(byval centerX as long, byval centerY as long, byval radius as single, byval color as RayColor)
declare sub DrawCircleSector(byval center as Vector2, byval radius as single, byval startAngle as single, byval endAngle as single, byval segments as long, byval color as RayColor)
declare sub DrawCircleSectorLines(byval center as Vector2, byval radius as single, byval startAngle as single, byval endAngle as single, byval segments as long, byval color as RayColor)
...
declare sub DrawCircleV(byval center as Vector2, byval radius as single, byval color as RayColor)
declare sub DrawCircleLines(byval centerX as long, byval centerY as long, byval radius as single, byval color as RayColor)
declare sub DrawEllipse(byval centerX as long, byval centerY as long, byval radiusH as single, byval radiusV as single, byval color as RayColor)
declare sub DrawEllipseLines(byval centerX as long, byval centerY as long, byval radiusH as single, byval radiusV as single, byval color as RayColor)
declare sub DrawRing(byval center as Vector2, byval innerRadius as single, byval outerRadius as single, byval startAngle as single, byval endAngle as single, byval segments as long, byval color as RayColor)
declare sub DrawRingLines(byval center as Vector2, byval innerRadius as single, byval outerRadius as single, byval startAngle as single, byval endAngle as single, byval segments as long, byval color as RayColor)
declare sub DrawRectangle(byval posX as long, byval posY as long, byval width as long, byval height as long, byval color as RayColor)
declare sub DrawRectangleV(byval position as Vector2, byval size as Vector2, byval color as RayColor)
declare sub DrawRectangleRec(byval rec as Rectangle, byval color as RayColor)
declare sub DrawRectanglePro(byval rec as Rectangle, byval origin as Vector2, byval rotation as single, byval color as RayColor)
declare sub DrawRectangleGradientV(byval posX as long, byval posY as long, byval width as long, byval height as long, byval color1 as RayColor, byval color2 as RayColor)
declare sub DrawRectangleGradientH(byval posX as long, byval posY as long, byval width as long, byval height as long, byval color1 as RayColor, byval color2 as RayColor)
...
declare sub DrawRectangleLines(byval posX as long, byval posY as long, byval width as long, byval height as long, byval color as RayColor)
declare sub DrawRectangleLinesEx(byval rec as Rectangle, byval lineThick as single, byval color as RayColor)
declare sub DrawRectangleRounded(byval rec as Rectangle, byval roundness as single, byval segments as long, byval color as RayColor)
declare sub DrawRectangleRoundedLines(byval rec as Rectangle, byval roundness as single, byval segments as long, byval lineThick as single, byval color as RayColor)
declare sub DrawTriangle(byval v1 as Vector2, byval v2 as Vector2, byval v3 as Vector2, byval color as RayColor)
declare sub DrawTriangleLines(byval v1 as Vector2, byval v2 as Vector2, byval v3 as Vector2, byval color as RayColor)
declare sub DrawTriangleFan(byval points as Vector2 ptr, byval pointCount as long, byval color as RayColor)
declare sub DrawTriangleStrip(byval points as Vector2 ptr, byval pointCount as long, byval color as RayColor)
declare sub DrawPoly(byval center as Vector2, byval sides as long, byval radius as single, byval rotation as single, byval color as RayColor)
declare sub DrawPolyLines(byval center as Vector2, byval sides as long, byval radius as single, byval rotation as single, byval color as RayColor)
declare sub DrawPolyLinesEx(byval center as Vector2, byval sides as long, byval radius as single, byval rotation as single, byval lineThick as single, byval color as RayColor)
...
declare function GenImageColor(byval width as long, byval height as long, byval color as RayColor) as Image
declare function GenImageGradientV(byval width as long, byval height as long, byval top as RayColor, byval bottom as RayColor) as Image
declare function GenImageGradientH(byval width as long, byval height as long, byval left as RayColor, byval right as RayColor) as Image
declare function GenImageGradientRadial(byval width as long, byval height as long, byval density as single, byval inner as RayColor, byval outer as RayColor) as Image
declare function GenImageChecked(byval width as long, byval height as long, byval checksX as long, byval checksY as long, byval col1 as RayColor, byval col2 as RayColor) as Image
...
declare function ImageText(byval text as const zstring ptr, byval fontSize as long, byval color as RayColor) as Image
declare function ImageTextEx(byval font as Font, byval text as const zstring ptr, byval fontSize as single, byval spacing as single, byval tint as RayColor) as Image
declare sub ImageFormat(byval image as Image ptr, byval newFormat as long)
declare sub ImageToPOT(byval image as Image ptr, byval fill as RayColor)
...
declare sub ImageAlphaClear(byval image as Image ptr, byval color as RayColor, byval threshold as single)
...
declare sub ImageResizeCanvas(byval image as Image ptr, byval newWidth as long, byval newHeight as long, byval offsetX as long, byval offsetY as long, byval fill as RayColor)
...
declare sub ImageColorTint(byval image as Image ptr, byval color as RayColor)
...
declare sub ImageColorReplace(byval image as Image ptr, byval color as RayColor, byval replace as RayColor)
declare function LoadImageColors(byval image as Image) as RayColor ptr
declare function LoadImagePalette(byval image as Image, byval maxPaletteSize as long, byval colorCount as long ptr) as RayColor ptr
...
declare function GetImageColor(byval image as Image, byval x as long, byval y as long) as RayColor
declare sub ImageClearBackground(byval dst as Image ptr, byval color as RayColor)
declare sub ImageDrawPixel(byval dst as Image ptr, byval posX as long, byval posY as long, byval color as RayColor)
declare sub ImageDrawPixelV(byval dst as Image ptr, byval position as Vector2, byval color as RayColor)
declare sub ImageDrawLine(byval dst as Image ptr, byval startPosX as long, byval startPosY as long, byval endPosX as long, byval endPosY as long, byval color as RayColor)
declare sub ImageDrawLineV(byval dst as Image ptr, byval start as Vector2, byval end_ as Vector2, byval color as RayColor)
declare sub ImageDrawCircle(byval dst as Image ptr, byval centerX as long, byval centerY as long, byval radius as long, byval color as RayColor)
declare sub ImageDrawCircleV(byval dst as Image ptr, byval center as Vector2, byval radius as long, byval color as RayColor)
declare sub ImageDrawRectangle(byval dst as Image ptr, byval posX as long, byval posY as long, byval width as long, byval height as long, byval color as RayColor)
declare sub ImageDrawRectangleV(byval dst as Image ptr, byval position as Vector2, byval size as Vector2, byval color as RayColor)
declare sub ImageDrawRectangleRec(byval dst as Image ptr, byval rec as Rectangle, byval color as RayColor)
declare sub ImageDrawRectangleLines(byval dst as Image ptr, byval rec as Rectangle, byval thick as long, byval color as RayColor)
...
declare sub ImageDrawText(byval dst as Image ptr, byval text as const zstring ptr, byval posX as long, byval posY as long, byval fontSize as long, byval color as RayColor)
...
declare sub DrawTexture(byval texture as Texture2D, byval posX as long, byval posY as long, byval tint as RayColor)
declare sub DrawTextureV(byval texture as Texture2D, byval position as Vector2, byval tint as RayColor)
declare sub DrawTextureEx(byval texture as Texture2D, byval position as Vector2, byval rotation as single, byval scale as single, byval tint as RayColor)
declare sub DrawTextureRec(byval texture as Texture2D, byval source as Rectangle, byval position as Vector2, byval tint as RayColor)
declare sub DrawTextureQuad(byval texture as Texture2D, byval tiling as Vector2, byval offset as Vector2, byval quad as Rectangle, byval tint as RayColor)
declare sub DrawTextureTiled(byval texture as Texture2D, byval source as Rectangle, byval dest as Rectangle, byval origin as Vector2, byval rotation as single, byval scale as single, byval tint as RayColor)
declare sub DrawTexturePro(byval texture as Texture2D, byval source as Rectangle, byval dest as Rectangle, byval origin as Vector2, byval rotation as single, byval tint as RayColor)
declare sub DrawTextureNPatch(byval texture as Texture2D, byval nPatchInfo as NPatchInfo, byval dest as Rectangle, byval origin as Vector2, byval rotation as single, byval tint as RayColor)
declare sub DrawTexturePoly(byval texture as Texture2D, byval center as Vector2, byval points as Vector2 ptr, byval texcoords as Vector2 ptr, byval pointCount as long, byval tint as RayColor)
declare function Fade(byval color as RayColor, byval alpha as single) as RayColor
declare function ColorToInt(byval color as RayColor) as long
declare function ColorNormalize(byval color as RayColor) as Vector4
declare function ColorFromNormalized(byval normalized as Vector4) as RayColor
declare function ColorToHSV(byval color as RayColor) as Vector3
declare function ColorFromHSV(byval hue as single, byval saturation as single, byval value as single) as RayColor
declare function ColorAlpha(byval color as RayColor, byval alpha as single) as RayColor
...
declare function GetPixelColor(byval srcPtr as any ptr, byval format as long) as RayColor
declare sub SetPixelColor(byval dstPtr as any ptr, byval color as RayColor, byval format as long)
...
declare function LoadFontFromImage(byval image as Image, byval key as RayColor, byval firstChar as long) as Font
...
declare sub DrawText(byval text as const zstring ptr, byval posX as long, byval posY as long, byval fontSize as long, byval color as RayColor)
declare sub DrawTextEx(byval font as Font, byval text as const zstring ptr, byval position as Vector2, byval fontSize as single, byval spacing as single, byval tint as RayColor)
declare sub DrawTextPro(byval font as Font, byval text as const zstring ptr, byval position as Vector2, byval origin as Vector2, byval rotation as single, byval fontSize as single, byval spacing as single, byval tint as RayColor)
declare sub DrawTextCodepoint(byval font as Font, byval codepoint as long, byval position as Vector2, byval fontSize as single, byval tint as RayColor)
declare sub DrawTextCodepoints(byval font as Font, byval codepoints as const long ptr, byval count as long, byval position as Vector2, byval fontSize as single, byval spacing as single, byval tint as RayColor)
...
declare sub DrawLine3D(byval startPos as Vector3, byval endPos as Vector3, byval color as RayColor)
declare sub DrawPoint3D(byval position as Vector3, byval color as RayColor)
declare sub DrawCircle3D(byval center as Vector3, byval radius as single, byval rotationAxis as Vector3, byval rotationAngle as single, byval color as RayColor)
declare sub DrawTriangle3D(byval v1 as Vector3, byval v2 as Vector3, byval v3 as Vector3, byval color as RayColor)
declare sub DrawTriangleStrip3D(byval points as Vector3 ptr, byval pointCount as long, byval color as RayColor)
declare sub DrawCube(byval position as Vector3, byval width as single, byval height as single, byval length as single, byval color as RayColor)
declare sub DrawCubeV(byval position as Vector3, byval size as Vector3, byval color as RayColor)
declare sub DrawCubeWires(byval position as Vector3, byval width as single, byval height as single, byval length as single, byval color as RayColor)
declare sub DrawCubeWiresV(byval position as Vector3, byval size as Vector3, byval color as RayColor)
declare sub DrawCubeTexture(byval texture as Texture2D, byval position as Vector3, byval width as single, byval height as single, byval length as single, byval color as RayColor)
declare sub DrawCubeTextureRec(byval texture as Texture2D, byval source as Rectangle, byval position as Vector3, byval width as single, byval height as single, byval length as single, byval color as RayColor)
declare sub DrawSphere(byval centerPos as Vector3, byval radius as single, byval color as RayColor)
declare sub DrawSphereEx(byval centerPos as Vector3, byval radius as single, byval rings as long, byval slices as long, byval color as RayColor)
declare sub DrawSphereWires(byval centerPos as Vector3, byval radius as single, byval rings as long, byval slices as long, byval color as RayColor)
declare sub DrawCylinder(byval position as Vector3, byval radiusTop as single, byval radiusBottom as single, byval height as single, byval slices as long, byval color as RayColor)
declare sub DrawCylinderEx(byval startPos as Vector3, byval endPos as Vector3, byval startRadius as single, byval endRadius as single, byval sides as long, byval color as RayColor)
declare sub DrawCylinderWires(byval position as Vector3, byval radiusTop as single, byval radiusBottom as single, byval height as single, byval slices as long, byval color as RayColor)
declare sub DrawCylinderWiresEx(byval startPos as Vector3, byval endPos as Vector3, byval startRadius as single, byval endRadius as single, byval sides as long, byval color as RayColor)
declare sub DrawPlane(byval centerPos as Vector3, byval size as Vector2, byval color as RayColor)
declare sub DrawRay(byval ray as Ray, byval color as RayColor)
...
declare sub DrawModel(byval model as Model, byval position as Vector3, byval scale as single, byval tint as RayColor)
declare sub DrawModelEx(byval model as Model, byval position as Vector3, byval rotationAxis as Vector3, byval rotationAngle as single, byval scale as Vector3, byval tint as RayColor)
declare sub DrawModelWires(byval model as Model, byval position as Vector3, byval scale as single, byval tint as RayColor)
declare sub DrawModelWiresEx(byval model as Model, byval position as Vector3, byval rotationAxis as Vector3, byval rotationAngle as single, byval scale as Vector3, byval tint as RayColor)
declare sub DrawBoundingBox(byval box as BoundingBox, byval color as RayColor)
declare sub DrawBillboard(byval camera as Camera, byval texture as Texture2D, byval position as Vector3, byval size as single, byval tint as RayColor)
declare sub DrawBillboardRec(byval camera as Camera, byval texture as Texture2D, byval source as Rectangle, byval position as Vector3, byval size as Vector2, byval tint as RayColor)
declare sub DrawBillboardPro(byval camera as Camera, byval texture as Texture2D, byval source as Rectangle, byval position as Vector3, byval up as Vector3, byval size as Vector2, byval origin as Vector2, byval rotation as single, byval tint as RayColor)
