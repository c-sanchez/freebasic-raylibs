''
'' raylib.bi - raylib v4.5 bindings for FreeBASIC
''
'' Generated based on raylib.h v4.5, following detailed conversion instructions.
'' Corrected based on compiler feedback from previous versions.
''
'' License: zlib/libpng
...
' Some Basic Colors
#define LIGHTGRAY  type<Color>( 200, 200, 200, 255 )   ' Light Gray
#define GRAY       type<Color>( 130, 130, 130, 255 )   ' Gray
#define DARKGRAY   type<Color>( 80, 80, 80, 255 )      ' Dark Gray
#define YELLOW     type<Color>( 253, 249, 0, 255 )     ' Yellow
#define GOLD       type<Color>( 255, 203, 0, 255 )     ' Gold
#define ORANGE     type<Color>( 255, 161, 0, 255 )     ' Orange
#define PINK       type<Color>( 255, 109, 194, 255 )   ' Pink
#define RED        type<Color>( 230, 41, 55, 255 )     ' Red
#define MAROON     type<Color>( 190, 33, 55, 255 )     ' Maroon
#define GREEN      type<Color>( 0, 228, 48, 255 )      ' Green
#define LIME       type<Color>( 0, 158, 47, 255 )      ' Lime
#define DARKGREEN  type<Color>( 0, 117, 44, 255 )      ' Dark Green
#define SKYBLUE    type<Color>( 102, 191, 255, 255 )   ' Sky Blue
#define BLUE       type<Color>( 0, 121, 241, 255 )     ' Blue
#define DARKBLUE   type<Color>( 0, 82, 172, 255 )      ' Dark Blue
#define PURPLE     type<Color>( 200, 122, 255, 255 )   ' Purple
#define VIOLET     type<Color>( 135, 60, 190, 255 )    ' Violet
#define DARKPURPLE type<Color>( 112, 31, 126, 255 )    ' Dark Purple
#define BEIGE      type<Color>( 211, 176, 131, 255 )   ' Beige
#define BROWN      type<Color>( 127, 106, 79, 255 )    ' Brown
#define DARKBROWN  type<Color>( 76, 63, 47, 255 )      ' Dark Brown

#define WHITE      type<Color>( 255, 255, 255, 255 )   ' White
#define BLACK      type<Color>( 0, 0, 0, 255 )         ' Black
#define BLANK      type<Color>( 0, 0, 0, 0 )           ' Blank (Transparent)
#define MAGENTA    type<Color>( 255, 0, 255, 255 )     ' Magenta
#define RAYWHITE   type<Color>( 245, 245, 245, 255 )   ' My own White (raylib logo)

'====================================================================================
' Definición de struct Base
'====================================================================================
...
'====================================================================================
' Definición de struct Compuestos
'====================================================================================
...
'====================================================================================
' Definición de type de Callbacks
'====================================================================================
...
declare function IsShaderReady(byval shader as Shader) as bool
...
declare function ExportDataAsCode(byval data as const ubyte ptr, byval size as ulong, byval fileName as const zstring ptr) as bool
...
declare sub DrawLineBezierQuad(byval startPos as Vector2, byval endPos as Vector2, byval controlPos as Vector2, byval thick as single, byval color as Color)
declare sub DrawLineBezierCubic(byval startPos as Vector2, byval endPos as Vector2, byval startControlPos as Vector2, byval endControlPos as Vector2, byval thick as single, byval color as Color)
declare sub DrawLineStrip(byval points as Vector2 ptr, byval pointCount as long, byval color as Color)
...
declare sub DrawRectangleRoundedLines(byval rec as Rectangle, byval roundness as single, byval segments as long, byval lineThick as single, byval color as Color)
...
declare sub DrawTriangleFan(byval points as Vector2 ptr, byval pointCount as long, byval color as Color)
declare sub DrawTriangleStrip(byval points as Vector2 ptr, byval pointCount as long, byval color as Color)
...
declare function CheckCollisionPointPoly(byval point as Vector2, byval points as Vector2 ptr, byval pointCount as long) as bool
...
declare function IsImageReady(byval image as Image) as bool
...
declare function IsTextureReady(byval texture as Texture2D) as bool
declare sub UnloadTexture(byval texture as Texture2D)
declare function IsRenderTextureReady(byval target as RenderTexture2D) as bool
...
declare function IsFontReady(byval font as Font) as bool
...
declare sub DrawTextCodepoints(byval font as Font, byval codepoints as const long ptr, byval count as long, byval position as Vector2, byval fontSize as single, byval spacing as single, byval tint as Color)
...
declare function TextReplace(byval text as zstring ptr, byval replace as const zstring ptr, byval by_ as const zstring ptr) as zstring ptr
...
declare sub DrawTriangleStrip3D(byval points as Vector3 ptr, byval pointCount as long, byval color as Color)
...
declare function IsModelReady(byval model as Model) as bool
...
declare sub DrawBillboard(byval camera as Camera, byval texture as Texture2D, byval position as Vector3, byval size as single, byval tint as Color)
...
declare function IsMaterialReady(byval material as Material) as bool
...
declare function IsWaveReady(byval wave as Wave) as bool
...
declare function IsSoundReady(byval sound as Sound) as bool
...
declare function IsMusicReady(byval music as Music) as bool
...
declare function IsAudioStreamReady(byval stream as AudioStream) as bool
