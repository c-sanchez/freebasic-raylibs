...
#define LIGHTGRAY  type<RayColor>( 200, 200, 200, 255 )  ' LIGHTGRAY
#define GRAY       type<RayColor>( 130, 130, 130, 255 )  ' GRAY
#define DARKGRAY   type<RayColor>( 80, 80, 80, 255 )     ' DARKGRAY
#define YELLOW     type<RayColor>( 253, 249, 0, 255 )    ' YELLOW
#define GOLD       type<RayColor>( 255, 203, 0, 255 )    ' GOLD
#define ORANGE     type<RayColor>( 255, 161, 0, 255 )    ' ORANGE
#define PINK       type<RayColor>( 255, 109, 194, 255 )  ' PINK
#define RED        type<RayColor>( 230, 41, 55, 255 )    ' RED
#define MAROON     type<RayColor>( 190, 33, 55, 255 )    ' MAROON
#define GREEN      type<RayColor>( 0, 228, 48, 255 )     ' GREEN
#define LIME       type<RayColor>( 0, 158, 47, 255 )     ' LIME
#define DARKGREEN  type<RayColor>( 0, 117, 44, 255 )     ' DARKGREEN
#define SKYBLUE    type<RayColor>( 102, 191, 255, 255 )  ' SKYBLUE
#define RAYBLUE    type<RayColor>( 0, 121, 241, 255 )    ' BLUE
#define DARKBLUE   type<RayColor>( 0, 82, 172, 255 )     ' DARKBLUE
#define PURPLE     type<RayColor>( 200, 122, 255, 255 )  ' PURPLE
#define VIOLET     type<RayColor>( 135, 60, 190, 255 )   ' VIOLET
#define DARKPURPLE type<RayColor>( 112, 31, 126, 255 )   ' DARKPURPLE
#define BEIGE      type<RayColor>( 211, 176, 131, 255 )  ' BEIGE
#define BROWN      type<RayColor>( 127, 106, 79, 255 )   ' BROWN
#define DARKBROWN  type<RayColor>( 76, 63, 47, 255 )     ' DARKBROWN
#define WHITE      type<RayColor>( 255, 255, 255, 255 )  ' WHITE
#define BLACK      type<RayColor>( 0, 0, 0, 255 )        ' BLACK
#define BLANK      type<RayColor>( 0, 0, 0, 0 )          ' BLANK
#define MAGENTA    type<RayColor>( 255, 0, 255, 255 )    ' MAGENTA
#define RAYWHITE   type<RayColor>( 245, 245, 245, 255 )  ' RAYWHITE
...
type rAudioProcessor as rAudioProcessor
...
declare sub ClearBackground(byval RayColor as RayColor)
...
declare sub BeginVrStereoMode(config as VrStereoConfig)
declare sub EndVrStereoMode()
declare function LoadVrStereoConfig(byval device as VrDeviceInfo) as VrStereoConfig
declare sub UnloadVrStereoConfig(config as VrStereoConfig)
...
declare sub DrawPixel(byval posX as long, byval posY as long, byval RayColor as RayColor)
declare sub DrawPixelV(byval position as Vector2, byval RayColor as RayColor)
declare sub DrawLine(byval startPosX as long, byval startPosY as long, byval endPosX as long, byval endPosY as long, byval RayColor as RayColor)
declare sub DrawLineV(byval startPos as Vector2, byval endPos as Vector2, byval RayColor as RayColor)
declare sub DrawLineEx(byval startPos as Vector2, byval endPos as Vector2, byval thick as single, byval RayColor as RayColor)
declare sub DrawLineBezier(byval startPos as Vector2, byval endPos as Vector2, byval thick as single, byval RayColor as RayColor)
declare sub DrawLineBezierQuad(byval startPos as Vector2, byval endPos as Vector2, byval controlPos as Vector2, byval thick as single, byval RayColor as RayColor)
declare sub DrawLineBezierCubic(byval startPos as Vector2, byval endPos as Vector2, byval startControlPos as Vector2, byval endControlPos as Vector2, byval thick as single, byval RayColor as RayColor)
declare sub DrawLineStrip(byval points as Vector2 ptr, byval pointCount as long, byval RayColor as RayColor)
declare sub DrawCircle(byval centerX as long, byval centerY as long, byval radius as single, byval RayColor as RayColor)
declare sub DrawCircleSector(byval center as Vector2, byval radius as single, byval startAngle as single, byval endAngle as single, byval segments as long, byval RayColor as RayColor)
declare sub DrawCircleSectorLines(byval center as Vector2, byval radius as single, byval startAngle as single, byval endAngle as single, byval segments as long, byval RayColor as RayColor)
...
declare sub DrawCircleV(byval center as Vector2, byval radius as single, byval RayColor as RayColor)
declare sub DrawCircleLines(byval centerX as long, byval centerY as long, byval radius as single, byval RayColor as RayColor)
declare sub DrawEllipse(byval centerX as long, byval centerY as long, byval radiusH as single, byval radiusV as single, byval RayColor as RayColor)
declare sub DrawEllipseLines(byval centerX as long, byval centerY as long, byval radiusH as single, byval radiusV as single, byval RayColor as RayColor)
declare sub DrawRing(byval center as Vector2, byval innerRadius as single, byval outerRadius as single, byval startAngle as single, byval endAngle as single, byval segments as long, byval RayColor as RayColor)
declare sub DrawRingLines(byval center as Vector2, byval innerRadius as single, byval outerRadius as single, byval startAngle as single, byval endAngle as single, byval segments as long, byval RayColor as RayColor)
declare sub DrawRectangle(byval posX as long, byval posY as long, byval width as long, byval height as long, byval RayColor as RayColor)
declare sub DrawRectangleV(byval position as Vector2, byval size as Vector2, byval RayColor as RayColor)
declare sub DrawRectangleRec(byval rec as Rectangle, byval RayColor as RayColor)
declare sub DrawRectanglePro(byval rec as Rectangle, byval origin as Vector2, byval rotation as single, byval RayColor as RayColor)
...
declare sub DrawRectangleLines(byval posX as long, byval posY as long, byval width as long, byval height as long, byval RayColor as RayColor)
declare sub DrawRectangleLinesEx(byval rec as Rectangle, byval lineThick as single, byval RayColor as RayColor)
declare sub DrawRectangleRounded(byval rec as Rectangle, byval roundness as single, byval segments as long, byval RayColor as RayColor)
declare sub DrawRectangleRoundedLines(byval rec as Rectangle, byval roundness as single, byval segments as long, byval lineThick as single, byval RayColor as RayColor)
declare sub DrawTriangle(byval v1 as Vector2, byval v2 as Vector2, byval v3 as Vector2, byval RayColor as RayColor)
declare sub DrawTriangleLines(byval v1 as Vector2, byval v2 as Vector2, byval v3 as Vector2, byval RayColor as RayColor)
declare sub DrawTriangleFan(byval points as Vector2 ptr, byval pointCount as long, byval RayColor as RayColor)
declare sub DrawTriangleStrip(byval points as Vector2 ptr, byval pointCount as long, byval RayColor as RayColor)
declare sub DrawPoly(byval center as Vector2, byval sides as long, byval radius as single, byval rotation as single, byval RayColor as RayColor)
declare sub DrawPolyLines(byval center as Vector2, byval sides as long, byval radius as single, byval rotation as single, byval RayColor as RayColor)
declare sub DrawPolyLinesEx(byval center as Vector2, byval sides as long, byval radius as single, byval rotation as single, byval lineThick as single, byval RayColor as RayColor)
...
declare function GenImageColor(byval width as long, byval height as long, byval RayColor as RayColor) as Image
...
declare function ImageText(byval text as const zstring ptr, byval fontSize as long, byval RayColor as RayColor) as Image
...
declare sub ImageAlphaClear(byval image as Image ptr, byval RayColor as RayColor, byval threshold as single)
...
declare sub ImageColorTint(byval image as Image ptr, byval RayColor as RayColor)
...
declare sub ImageColorReplace(byval image as Image ptr, byval RayColor as RayColor, byval replace as RayColor)
...
declare sub ImageClearBackground(byval dst as Image ptr, byval RayColor as RayColor)
declare sub ImageDrawPixel(byval dst as Image ptr, byval posX as long, byval posY as long, byval RayColor as RayColor)
declare sub ImageDrawPixelV(byval dst as Image ptr, byval position as Vector2, byval RayColor as RayColor)
declare sub ImageDrawLine(byval dst as Image ptr, byval startPosX as long, byval startPosY as long, byval endPosX as long, byval endPosY as long, byval RayColor as RayColor)
declare sub ImageDrawLineV(byval dst as Image ptr, byval start as Vector2, byval end as Vector2, byval RayColor as RayColor)
declare sub ImageDrawCircle(byval dst as Image ptr, byval centerX as long, byval centerY as long, byval radius as long, byval RayColor as RayColor)
declare sub ImageDrawCircleV(byval dst as Image ptr, byval center as Vector2, byval radius as long, byval RayColor as RayColor)
declare sub ImageDrawRectangle(byval dst as Image ptr, byval posX as long, byval posY as long, byval width as long, byval height as long, byval RayColor as RayColor)
declare sub ImageDrawRectangleV(byval dst as Image ptr, byval position as Vector2, byval size as Vector2, byval RayColor as RayColor)
declare sub ImageDrawRectangleRec(byval dst as Image ptr, byval rec as Rectangle, byval RayColor as RayColor)
declare sub ImageDrawRectangleLines(byval dst as Image ptr, byval rec as Rectangle, byval thick as long, byval RayColor as RayColor)
...
declare sub ImageDrawText(byval dst as Image ptr, byval text as const zstring ptr, byval posX as long, byval posY as long, byval fontSize as long, byval RayColor as RayColor)
...
declare function Fade(byval RayColor as RayColor, byval alpha as single) as RayColor
declare function ColorToInt(byval RayColor as RayColor) as long
declare function ColorNormalize(byval RayColor as RayColor) as Vector4
declare function ColorFromNormalized(byval normalized as Vector4) as RayColor
declare function ColorToHSV(byval RayColor as RayColor) as Vector3
declare function ColorFromHSV(byval hue as single, byval saturation as single, byval value as single) as RayColor
declare function ColorAlpha(byval RayColor as RayColor, byval alpha as single) as RayColor
...
declare sub SetPixelColor(byval dstPtr as any ptr, byval RayColor as RayColor, byval format as long)
...
declare sub DrawText(byval text as const zstring ptr, byval posX as long, byval posY as long, byval fontSize as long, byval RayColor as RayColor)
...
declare sub DrawLine3D(byval startPos as Vector3, byval endPos as Vector3, byval RayColor as RayColor)
declare sub DrawPoint3D(byval position as Vector3, byval RayColor as RayColor)
declare sub DrawCircle3D(byval center as Vector3, byval radius as single, byval rotationAxis as Vector3, byval rotationAngle as single, byval RayColor as RayColor)
declare sub DrawTriangle3D(byval v1 as Vector3, byval v2 as Vector3, byval v3 as Vector3, byval RayColor as RayColor)
declare sub DrawTriangleStrip3D(byval points as Vector3 ptr, byval pointCount as long, byval RayColor as RayColor)
declare sub DrawCube(byval position as Vector3, byval width as single, byval height as single, byval length as single, byval RayColor as RayColor)
declare sub DrawCubeV(byval position as Vector3, byval size as Vector3, byval RayColor as RayColor)
declare sub DrawCubeWires(byval position as Vector3, byval width as single, byval height as single, byval length as single, byval RayColor as RayColor)
declare sub DrawCubeWiresV(byval position as Vector3, byval size as Vector3, byval RayColor as RayColor)
declare sub DrawCubeTexture(byval texture as Texture2D, byval position as Vector3, byval width as single, byval height as single, byval length as single, byval RayColor as RayColor)
declare sub DrawCubeTextureRec(byval texture as Texture2D, byval source as Rectangle, byval position as Vector3, byval width as single, byval height as single, byval length as single, byval RayColor as RayColor)
declare sub DrawSphere(byval centerPos as Vector3, byval radius as single, byval RayColor as RayColor)
declare sub DrawSphereEx(byval centerPos as Vector3, byval radius as single, byval rings as long, byval slices as long, byval RayColor as RayColor)
declare sub DrawSphereWires(byval centerPos as Vector3, byval radius as single, byval rings as long, byval slices as long, byval RayColor as RayColor)
declare sub DrawCylinder(byval position as Vector3, byval radiusTop as single, byval radiusBottom as single, byval height as single, byval slices as long, byval RayColor as RayColor)
declare sub DrawCylinderEx(byval startPos as Vector3, byval endPos as Vector3, byval startRadius as single, byval endRadius as single, byval sides as long, byval RayColor as RayColor)
declare sub DrawCylinderWires(byval position as Vector3, byval radiusTop as single, byval radiusBottom as single, byval height as single, byval slices as long, byval RayColor as RayColor)
declare sub DrawCylinderWiresEx(byval startPos as Vector3, byval endPos as Vector3, byval startRadius as single, byval endRadius as single, byval sides as long, byval RayColor as RayColor)
declare sub DrawPlane(byval centerPos as Vector3, byval size as Vector2, byval RayColor as RayColor)
declare sub DrawRay(byval ray as Ray, byval RayColor as RayColor)
...
declare sub DrawBoundingBox(byval box as BoundingBox, byval RayColor as RayColor)
