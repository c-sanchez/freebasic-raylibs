''
'' raylib.bi - raylib v5.0 bindings for FreeBASIC
''
'' Generated based on raylib.h v5.0, following detailed conversion instructions.
...
declare sub UnloadAutomationEventList(byval list as AutomationEventList ptr)
...
declare sub DrawSplineLinear(byval points as Vector2 ptr, byval pointCount as long, byval thick as single, byval color as Color)
declare sub DrawSplineBasis(byval points as Vector2 ptr, byval pointCount as long, byval thick as single, byval color as Color)
declare sub DrawSplineCatmullRom(byval points as Vector2 ptr, byval pointCount as long, byval thick as single, byval color as Color)
declare sub DrawSplineBezierQuadratic(byval points as Vector2 ptr, byval pointCount as long, byval thick as single, byval color as Color)
declare sub DrawSplineBezierCubic(byval points as Vector2 ptr, byval pointCount as long, byval thick as single, byval color as Color)
